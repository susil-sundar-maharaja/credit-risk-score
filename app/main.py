...
st.set_page_config(page_title='Credit Risk Modelling') #set the page config title
st.title('Credit Risk Modelling')

row1= st.columns(3) #create rows and columns for each input
row2= st.columns(3)
row3= st.columns(3)
row4= st.columns(3)
